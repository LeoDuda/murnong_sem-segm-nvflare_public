...
class SwarmClientController(ClientSideController):
    def __init__(
        ...
        #    output_file="server_controller_emissions.csv"
        #)
    ...
    #@perun.perun(data_out=f"perun_execute_results_{timestamp}", app_name="execute")
    ...
    #@perun.perun(data_out=f"perun_start_run_results_{timestamp}", app_name="start_run")
    ...
    @perun.perun(data_out=f"perun_start_workflow_results_{timestamp}", app_name="start_workflow")
    ...
    @perun.perun(data_out=f"perun_scatter_results_{timestamp}", app_name="scatter")
    ...
    @perun.perun(data_out=f"perun_distribute_final_results_results_{timestamp}", app_name="distribute_final_results")
    ...
    @perun.perun(data_out=f"perun_do_learn_task_results_{timestamp}", app_name="do_learn_task")
    ...
    @perun.perun(data_out=f"perun_process_share_result_results_{timestamp}", app_name="process_share_result")
