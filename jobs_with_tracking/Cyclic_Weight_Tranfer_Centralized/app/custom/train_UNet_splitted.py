...
# -*- coding: utf-8 -*-
# Fahimehs changes:
#   2- Changed the model_dir to a fixed for saving the model. Because in 
...
def main(
    ...
    #for a distributed dataset each client loads different data
    ...
    @perun.perun(data_out="perun_train_results", app_name="train",)
    @flare.train
    def train(input_model=None):
        ...
        #check if the git info is available and add it to the dict of params which will be tracked
    ...
    while flare.is_running():
        ...
        output = train(input_model=input_model)
...
def load_data(site):
    ...
    """
    # assiging different sites different datasets. 
    # If not necessary anymore just change scripts.segm_models._utils import.ImageProcessor and MaskProcessor
    if site=="site-1":
        data_path = "/hkfs/home/project/hk-project-test-p0023500/mp9809/datasets/dataset_MU/"
    else:
        data_path = "/hkfs/home/haicore/scc/mp9809/dataset_KA/"
